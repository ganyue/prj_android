...
public class LocalCover implements ICoverRetriever {
    ...
    public LocalCover(Application app, SharedPreferences settings) {
        this.app = app;
    ...
    public String[] getCoverUrl(AlbumInfo albumInfo) throws Exception {
        ...
        if (musicPath != null) {
            // load server name/ip
            final String serverName = MpdManage.getInstance(app).oMPDAsyncHelper.getConnectionSettings().sServer;
