...
import com.gy.utils.audio.mpdplayer.event.StatusChangeListener;
import com.gy.utils.audio.mpdplayer.event.TrackPositionListener;
...
import com.gy.utils.audio.mpdplayer.mpd.MPDStatusMonitor;
import com.gy.utils.audio.mpdplayer.tools.Tools;
import com.gy.utils.audio.mpdplayer.tools.WeakLinkedList;
			...
			switch (msg.what) {
				case EVENT_CONNECT:
					try {
                        ...
                        Log.d("wl", "------开始连接--------"+conInfo.sServer+"---port--"+conInfo.iPort+ "--pwd----"+conInfo.sPassword);
						if (oMPD != null) {
				...
				case EVENT_DISCONNECT:
					try {
						...
						Log.e("wl", "Error on disconnect", e);// Silent exception are dangerous
					}
