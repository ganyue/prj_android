...
public class MPD {
    ...
    */
    ...
    public List<String> removeFromPlaylist(String playlistName, Integer pos) throws MPDServerException {
        return getMpdConnection().sendCommand(MPDCommand.MPD_CMD_PLAYLIST_DEL, playlistName, Integer.toString(pos));
    }
    ...
    public List<String> addToPlaylist(String playlistName, String url) throws MPDServerException {
        return getMpdConnection().sendCommand(MPDCommand.MPD_CMD_PLAYLIST_ADD, playlistName, url);
    }
